                        ...
                        <div class="card-body p-0">
                            <div class="p-5">
                                <div class="text-center">
                                    <h4 class="text-dark mb-4">New Brand</h4>
                                </div>
                                <p id="error" style="text-align: center;color: rgb(255,0,0);background: rgb(255,216,216);"></p>
                                <form id="form" class="user">
                                    <div class="mb-3">
                                        Name<br/>
                                        <input class="brandname form-control form-control-user" type="text" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Brand name" name="name" required>
                                    </div>
                ...
                <script type="text/javascript">
                 const urlredirect = '<%= request.getContextPath()+"/table/brand/1" %>';
                 const url = '<%= request.getContextPath()+"/save/brand" %>';
                 const formulaire = document.getElementById('form');
            
                 formulaire.addEventListener('submit', function (event) {
                      event.preventDefault(); // Empêche le formulaire d'être soumis
                      const name = Array.from(document.getElementsByClassName("brandname")).map(option => option.value);
                      console.log(name);
